...
\subsection{Theorem 5.5} \label{thm5.5}
...
\begin{solution}
\\ There is a sequence in $S$ that tends to sup $S$. Since $S$ is closed, this implies sup $S \in S$ by \hyperref[thm5.5]{Theorem 5.5}. \\
